...
namespace ArkWallet.Core.ShoppingContext.Application.Services.Orchestrators;

internal class MachineCreationOrchestrator(
    ArkWalletDbContext dbContext,
    IMachineCreationService machineCreationService,
    IMiningMachineRuleCreationService ruleCreationService,
    ILogger<MachineCreationOrchestrator> logger) : IMachineCreationOrchestrator
{
    public async Task<Result<MiningMachineCreationData>> CreateMachineAsync(MiningMachineCreationCommand command)
    {
        ...
        }, logger, nameof(MachineCreationOrchestrator));
    }
