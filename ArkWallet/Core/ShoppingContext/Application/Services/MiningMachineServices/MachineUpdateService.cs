...
internal class MachineUpdateService(ArkWalletDbContext dbContext, ILogger<MachineUpdateService> logger) : IMachineUpdateService
{
    public async Task<Result> UpdateMachineAsync(MiningMachineUpdateCommand command)
    {
        return await ServiceErrorHandler.ExecuteAsync(async () =>
        {
            ...
            return await TransactionHandler.ExecuteAsync(dbContext, async () =>
            {
                ...
                machine.Update(
                    command.Type != null ? MachineTypeParser.Parse(command.Type) : null,
        ...
        }, logger, nameof(MachineUpdateService));
    }
}
