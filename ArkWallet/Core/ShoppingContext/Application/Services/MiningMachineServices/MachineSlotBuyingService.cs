...
internal class MachineSlotBuyingService(
    ArkWalletDbContext dbContext,
    ILogger<MachineSlotBuyingService> logger,
    TimeProvider? timeProvider = null) : IMachineSlotBuyingService
{
    public async Task<Result<long>> BuyMachineAsync(long traderId, long machineId)
    {
        ...
        }, logger, nameof(MachineSlotBuyingService));
    }
