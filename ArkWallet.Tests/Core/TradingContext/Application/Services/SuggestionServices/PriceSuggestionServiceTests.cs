...
namespace ArkWallet.Tests.Core.TradingContext.Application.Services.SuggestionServices;
...
public class PriceSuggestionServiceTests
{
    ...
    public async Task GetSellPriceSuggestionsAsync_CancelledOrdersExcluded()
    {
        ...
        var expensiveBuy = orders.First(o => o.Type == OrderType.Buy && o.Price == 50);
        expensiveBuy.Status = OrderStatus.Cancelled;
        var cheapSell = orders.First(o => o.Type == OrderType.Sell && o.Price == 200);
        cheapSell.Status = OrderStatus.Filled;
    ...
    public async Task GetBuyPriceSuggestionsAsync_CancelledOrdersExcluded()
    {
        ...
        var orders = db.TradeOrders.ToList();
        var cheapBuy = orders.First(o => o.Type == OrderType.Buy && o.Price == 100);
        cheapBuy.Status = OrderStatus.Cancelled;
        await db.SaveChangesAsync();
